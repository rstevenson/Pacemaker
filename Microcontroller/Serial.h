...
//name: validHeader
//description: checks if the fncode is one of [k_pparams,k_echo,k_estop,k_egram]
//params: char fncode - fncode to check
//returns: short - 0 if not valid, 1 if valid
